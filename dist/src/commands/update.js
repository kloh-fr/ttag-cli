...
function update(pofile, src, lang, ttagOverrideOpts, ttagRcOpts, serializeOpts) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    _a = parser_1.parse;
                    return [4 /*yield*/, extract_1.extractAll(src, lang, progress, ttagOverrideOpts, ttagRcOpts)];
                case 2:
                    pot = _a.apply(void 0, [_b.sent()]);
                    po = parser_1.parse(fs.readFileSync(pofile).toString());
                    resultPo = update_1.updatePo(pot, po);
                    fs.writeFileSync(pofile, serializer_1.serialize(resultPo, serializeOpts));
